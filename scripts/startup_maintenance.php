...
// Вот эта штука удаляет данные из БД, если при запуске главного цикла было неккоректное системное время.
// Особенно актуально для плат Raspberry PI, Cubieboard и т.п., на которых нет часов реального времени.
// Поэтому нужно перед стартом главного цикла делать проверку на корректность системного времени!
// (например, принудительно провести синхронизацию времени по NTP)
